...
public class Main {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            String processDefinitions = getAllProcessDefinitions(alfresoTicket);
            System.out.println("=============== PROCESS DEFINITIONS RESULT IN JSON FORMAT ================");
            System.out.println(prettyJsonPrinter(processDefinitions));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static String getAllProcessDefinitions(String alfrescoTicket){
        String strReponse = "";
